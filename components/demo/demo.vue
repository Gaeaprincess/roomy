<template>
  <div>
    <div>
      ...
      <div class="cu-bar bg-white solid-bottom" style="margin-top:100urpx">
        <div class="action">
...
.solid::after {
	border: 1urpx solid rgba(0, 0, 0, 0.1);
}

.solid-bottom::after {
	border-bottom: 1urpx solid rgba(0, 0, 0, 0.1);
}
