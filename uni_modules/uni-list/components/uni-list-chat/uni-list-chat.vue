					...
					<view v-else class="uni-list-chat__header">
						<view v-for="(item, index) in avatarList" :key="index" class="uni-list-chat__header-box" :class="computedAvatar"
						 :style="{ width: imageWidth + 'rpx', height: imageWidth + 'rpx' }">
							<image class="uni-list-chat__header-image" :style="{ width: imageWidth + 'rpx', height: imageWidth + 'rpx' }" :src="item.url"
...
<style lang="scss" scoped>
	...
	$avatar-width: 45rpx;
	$avatar-border-radius: 5rpx;
	$avatar-border-color: #eee;
	$avatar-border-width: 1rpx;
	$title-size: 16rpx;
	$title-color: #3b4144;
	$title-weight: normal;
	$note-size: 12rpx;
	...
	.uni-list-chat__badge-pos {
		...
		/* #endif */
		/* #ifndef APP-NVUE */
		left: calc(#{$avatar-width} + 10rpx - #{$badge-space} + #{$badge-left});
		top: calc(#{$uni-spacing-row-base}/ 2 + 1rpx + #{$badge-top});
		/* #endif */
	}
	...
	.uni-badge--single {
		/* #ifndef APP-NVUE */
		// left: calc(#{$avatar-width} + 7rpx + #{$badge-left});
		/* #endif */
		width: $badge-size;
		height: $badge-size;
	}
	...
	.uni-badge--dot {
		...
		/* #endif */
		/* #ifndef APP-NVUE */
		left: calc(#{$avatar-width} + 15rpx - #{$dot-width}/ 2 + 1rpx + #{$badge-left});
		/* #endif */
		width: $dot-width;
		height: $dot-height;
		padding: 0;
